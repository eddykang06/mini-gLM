...
## Data
Pre-training data consisted of x sequences of min_length-max_length bp sampled from the [hg38](https://hgdownload.soe.ucsc.edu/goldenpath/hg38/bigZips/) human genome assembly. 
